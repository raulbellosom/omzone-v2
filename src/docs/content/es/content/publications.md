...
Las publicaciones son la **capa editorial** para el contenido de OMZONE, proporcionando la narrativa para el público, copy de marketing y páginas optimizadas para SEO que impulsan el tráfico orgánico. Existen separadamente de la capa comercial (experiencias, precios, horarios) y sirven puramente como contenido de marketing.
...
| Contenido    | Títulos, descripciones, imágenes, contenido de landing page | Niveles de precio, horarios, capacidad, tipo de entrega |
| Estado       | Borrador, Publicado, Archivado                              | Borrador, Publicado, Pausado, Archivado                 |
| Precios      | Sin campos de precio                                        | Niveles de precio con tipos de precio                   |
| Programación | Sin programación                                            | Horarios y disponibilidad                               |
| Vinculación  | Puede vincular a una Experiencia                            | Referenciada por Publicación                            |

> **Separación de dominio:** Las Publicaciones y las Experiencias son entidades separadas. Una Publicación puede vincular a una Experiencia, pero los cambios en una no afectan automáticamente a la otra. Esta separación permite que el contenido editorial permanezca estable mientras los detalles comerciales cambian.
